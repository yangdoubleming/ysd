<template>
    <section>
        <div class="authorize-box" style="position:relative">
            ...
            <div class="up">
                <img :src="wishLogo" class="up-left">
                <div class="up-right" @click="showDhGateDialog">
                    <span>新增并授权wish店铺</span>
                    <i class="el-icon-arrow-right"></i>
                </div>
            </div>
            <div class="down">
                <div class="down-left" @click="linkTo('wishAuthorizeList')">
                    <i class="el-icon-search"></i>
                    <span>查看授权店铺</span>
                </div>
                <div class="down-right">
                    <i class="el-icon-question"></i>
                    <a href="./index_files/wish.pdf" target="_blank">查看授权帮助</a>
                </div>
            </div>
        </div>
        <el-dialog
            ...
            :center="dhGateCenter"
            :width="setWidth">
            <a class="linkWord" href="./index_files/wish.pdf" target="_blank" >查看授权帮助</a>
            <el-form :model="dhGateValidateForm" ref="dhGateValidateForm" 
                ...
                <el-form-item label="授权码"  prop="code" >
                    <el-row>
                        <el-col :span="16">
                            <el-input v-model="dhGateValidateForm.code" autocomplete="off"></el-input>
                        </el-col>
...
<script>
    ...
    import wishLogo from '@/assets/register/wish_logo.png'
    ...
    export default {
        ...
        methods: {
            ...
            submitdhGateForm(formName) {
                ...
                if (valid) {
                    this.loading = true
                    authorize(this.dhGateValidateForm,'wish').then(result=>{
