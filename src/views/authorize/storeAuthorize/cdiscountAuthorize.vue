<template>
    <div class="authorize-box" style="position:relative">
        ...
        <div class="up">
            <img :src="cdiscountLogo" class="up-left">
            <div class="up-right"  style="width: 180px;text-overflow: ellipsis;overflow: hidden;white-space: nowrap;" @click="showDhGateDialog">
                <span>新增并授权cdiscount店铺</span>
        ...
        <div class="down">
            ...
            <div class="down-right">
                ...
                <a href="./index_files/cdiscount.pdf" target="_blank">查看授权帮助</a>
            </div>
        </div>
        <el-dialog
            title="Cdiscount-新增店铺并授权"
            :visible.sync="dhGateDialogVisible"
            :close-on-click-modal="modelStatus"
            :center="dhGateCenter"
            :width="setWidth">
            <a class="linkWord" href="./index_files/cdiscount.pdf" target="_blank" >查看授权帮助</a>
            <el-form :model="dhGateValidateForm" ref="dhGateValidateForm" 
                ...
                <el-form-item label="密码"  prop="password" >
                    <el-input v-model="dhGateValidateForm.password" autocomplete="off"></el-input>
                </el-form-item>
...
<script>
    ...
    import cdiscountLogo from '@/assets/register/cdiscount_logo.png'
    ...
    export default {
        ...
        methods: {
            ...
            submitdhGateForm(formName) {
                ...
                if (valid) {
                    this.loading = true
                    authorize(this.dhGateValidateForm,'cdiscount').then(result=>{
